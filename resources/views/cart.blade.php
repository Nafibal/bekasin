      ...
      <div class="col table-responsive mt-4 mx-3">
          <table class="table" >
              ...
              <tbody class="align-middle">
                  ...
                  <td><img src="../../public/image/BKS1001.jpg" style="width:100px"></td>
                  <td>Laptop Asus VivoBook S14 S430UN</td>
                  <td>Rp8,200,000</td>
                  ...
                  <tr>
                  <th scope="row"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                      <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z"/>
                      </svg>
                  </i></th>
                  <td><img src="../../public/image/BKS1031.jpg" style="width:100px"></td>
                  ...
                  <td><img src="../../public/image/BKS1080.jpg" style="width:100px"></td>

                  <td>Apple Watch Pink Series 6</td>
                  <td>Rp3,000,000</td>
                  <td><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dash-circle" viewBox="0 0 16 16">
                  <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                  <path d="M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8z"/>
                  ...
                  <td><img src="../../public/image/BKS1032.jpg" style="width:100px"></td>
  ...
  <div class="col table-responsive">
    <table class="table ms-auto text-center mb-5 mt-3 mx-3" id="table-checkout">
      ...
      <tbody>
        ...
        <td class=" th-header">Rp14,200,000</td>
        </tr>
        <tr>
        <td colspan="2" class="th-header">
          <div class="btn-checkout d-grid">
          <button class="btn btn-dark btn-sm mx-4">Checkout</button>
        </div>
        </td>
        </tr>
      </tbody>
